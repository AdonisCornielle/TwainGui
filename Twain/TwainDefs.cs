...
namespace ScanninControl
{
    ...
    public enum CopyOfTwainCommand
    {
        Not = -1,
        Null = 0,
        TransferReady = 1,
    ...
    internal enum CopyOfTwDAT : short
    {									// DAT_....
        Null = 0x0000,
        Capability = 0x0001,
        Event = 0x0002,
    ...
    internal enum CopyOfTwCap : short
    {
        XferCount = 0x0001,			// CAP_XFERCOUNT
        ICompression = 0x0100,			// ICAP_...
        IPixelType = 0x0101,
    ...
    [StructLayout(LayoutKind.Sequential, Pack = 2, CharSet = CharSet.Ansi)]
    internal struct CopyOfTwVersion
    {									// TW_VERSION
        public short MajorNum;
        public short MinorNum;
        public short Language;
